...
<head>
  ...
  <script>
	...
	if(!id){
      ...
      if(id) {
        var userInfo = ids + "님의 퍼스널 컬러 진단 결과: " + pcolor
        $("#pcolor1").append(userInfo);
        ...
        <div id="faceLabel" style="text-align: center;">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="pcolorSelect">
              <li><button class="dropdown-item" type="button">봄 웜</button></li>
              <li><button class="dropdown-item" type="button">여름 쿨</button></li>
              <li><button class="dropdown-item" type="button">가을 웜</button></li>
              <li><button class="dropdown-item" type="button">겨울 쿨</button></li>
            </ul>
          </div>
        </div>
